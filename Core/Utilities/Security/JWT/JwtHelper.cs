...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        public IConfiguration
            Configuration { get; } // IConfiguration webapı dki appsetting deki değerleri okumamıza yarıyo
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            _tokenOptions =
                Configuration.GetSection("TokenOptions")
                    .Get<TokenOptions>(); //appsetting deki verileri al tokenoptions takilere ata
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var signingCredentials =
                SigningCredentialsHelper
                    .CreateSigningCredentials(securityKey); // securitykey ve algoritmayı belirlediğimiz nesne
            var jwt = CreateJwtSecurityToken(_tokenOptions, user, signingCredentials, operationClaims);
            var jwtSecurityTokenHandler =
                new JwtSecurityTokenHandler(); // bu nesneyi kullanarak elimdeki token bilgisini yazdırıcam
        ...
        private IEnumerable<Claim> SetClaims(User user, List<OperationClaim> operationClaims)
        {
            ...
            claims.AddRoles(operationClaims.Select(c => c.Name)
                .ToArray()); //operation claims ICollection türünde olduğu için onu array e çevirdim
